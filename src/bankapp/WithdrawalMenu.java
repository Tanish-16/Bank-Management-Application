...
public class WithdrawalMenu extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        amountLabel.setForeground(new java.awt.Color(82, 87, 93));
        amountLabel.setText("Withdrawal Amount:");
        getContentPane().add(amountLabel);
        getContentPane().add(amountField);

        withdrawalButton.setBackground(new java.awt.Color(81, 99, 101));
        withdrawalButton.setForeground(new java.awt.Color(246, 244, 230));
